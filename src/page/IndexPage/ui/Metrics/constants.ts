...
export const CHIP_BRANDS = ["LYFT", "VELO", "KASTA", "FEDRS", "Stalker", "RED", "Corvus", "SIBERIA"];
...
export const SERIES_COUNT = new Set(products.map((p) => p.series).filter(Boolean)).size;
